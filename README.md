# Awesome Burp Extensions with stars
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,798 | 🐛 30 | 🌐 Kotlin | 📅 2026-06-17 -  A Comprehensive Burp Extension for GraphQL Security Testing
* [403Bypasser](https://github.com/sting8k/BurpSuite_403Bypasser) ⭐ 1,702 | 🐛 8 | 🌐 Python | 📅 2023-06-29 - An burpsuite extension to bypass 403 restricted directory.
...
* [Backslash Powered Scanner](https://github.com/PortSwigger/backslash-powered-scanner) ⭐ 714 | 🐛 2 | 🌐 Java | 📅 2025-04-30 - Finds unknown classes of injection vulnerabilities.
...
* [Active Scan++](https://github.com/albinowax/ActiveScanPlusPlus) ⭐ 663 | 🐛 6 | 🌐 Java | 📅 2026-07-20 - ActiveScan++ extends Burp Suite's active and passive scanning capabilities.
* [Log4Shell scanner for Burp Suite](https://github.com/silentsignal/burp-log4shell) ⭐ 486 | 🐛 3 | 🌐 Kotlin | 📅 2023-09-24 - If you'd like to scan only for Log4j (and not other things such as XSS or SQLi), this plugin makes it possible.
...
* [Agartha](https://github.com/volkandindar/agartha) ⭐ 401 | 🐛 0 | 🌐 Python | 📅 2026-05-28 - Agartha is a penetration testing tool which creates dynamic payload lists and user access matrix to reveal injection flaws and authentication/authorization issues.
* [JSpector ](https://github.com/hisxo/JSpector) ⭐ 378 | 🐛 0 | 🌐 Python | 📅 2023-07-25 - JSpector is a Burp Suite extension that passively crawls JavaScript files and automatically creates issues with URLs, endpoints and dangerous methods found on the JS files.
...
* [Minesweeper](https://github.com/codingo/Minesweeper) ⭐ 202 | 🐛 1 | 🌐 Python | 📅 2022-03-23 - A Burpsuite plugin (BApp) to aid in the detection of scripts being loaded from over 14000+ malicious cryptocurrency mining domains (cryptojacking).
...
* [Log4J Scanner](https://github.com/0xDexter0us/Log4J-Scanner/) ⭐ 102 | 🐛 0 | 🌐 Kotlin | 📅 2021-12-26 - Burp extension to scan Log4Shell (CVE-2021-44228) vulnerability pre and post auth.
...
* [HTTPoxy Scanner](https://github.com/PortSwigger/httpoxy-scanner) ⭐ 95 | 🐛 0 | 🌐 Java | 📅 2021-08-25 - A Burp Suite extension that checks for the HTTPoxy vulnerability.
* [DNS Analyzer](https://github.com/The-Login/DNS-Analyzer) ⭐ 91 | 🐛 1 | 🌐 Java | 📅 2023-09-12 - A Burp Suite extension for discovering DNS vulnerabilities in web applications!
* [Burp AEM Security Scanner Extension](https://github.com/thomashartm/burp-aem-scanner) ⚠️ Archived - Burp AEM Security Scanner is an AEM focussed plugin which supports the evaluation of well known misconfigurations of AEM installations.
* [FlareQuench](https://github.com/aress31/flarequench) ⭐ 66 | 🐛 1 | 🌐 Java | 📅 2022-11-29 - Burp Suite plugin that adds additional checks to the passive scanner to reveal the origin IP(s) of Cloudflare-protected web applications.
* [Error Message Checks](https://github.com/augustd/burp-suite-error-message-checks) ⭐ 65 | 🐛 9 | 🌐 Java | 📅 2023-12-15 - Burp Suite extension to passively scan for applications revealing server error messages.
...
* [Software Version Reporter](https://github.com/augustd/burp-suite-software-version-checks) ⭐ 33 | 🐛 4 | 🌐 Java | 📅 2024-05-30 - Burp extension to passively scan for applications revealing software version numbers.
* [Additional Scanner checks](https://github.com/portswigger/additional-scanner-checks) ⭐ 32 | 🐛 0 | 🌐 Python | 📅 2020-06-15 - Collection of scanner checks missing in Burp.
* [ActiveScan3Plus](https://github.com/silentsignal/ActiveScan3Plus) ⭐ 31 | 🐛 1 | 🌐 Python | 📅 2017-01-30 - Modified version of ActiveScan++ Burp Suite extension.
* [CTFHelper](https://github.com/unamer/CTFHelper) ⭐ 30 | 🐛 0 | 🌐 Python | 📅 2018-01-22 - This extension will scan some sensitive files (backup files likes .index.php.swp or .git directory) in web server that makes solving CTF challenge faster.
* [CSRF Scanner](https://github.com/ah8r/csrf) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2018-06-05 - CSRF Scanner Extension for Burp Suite Pro.
* [Identity Crisis](https://github.com/EnableSecurity/Identity-Crisis) ⚠️ Archived - A Burp Suite extension that checks if a particular URL responds differently to various User-Agent headers.
* [Burp Suite GWT Scan](https://github.com/augustd/burp-suite-gwt-scan) ⭐ 13 | 🐛 0 | 🌐 Java | 📅 2015-09-24 - Burp Suite plugin identifies insertion points for GWT (Google Web Toolkit) requests.
* [SRI Check](https://github.com/SolomonSklash/sri-check) ⭐ 13 | 🐛 1 | 🌐 Python | 📅 2019-06-12 - A Burp Suite extension for identifying missing Subresource Integrity attributes.
* [Scan manual insertion point](https://github.com/cnotin/burp-scan-manual-insertion-point) ⭐ 11 | 🐛 0 | 🌐 Java | 📅 2017-05-26 - This Burp extension lets the user select a region of a request (typically a parameter value), and via the context menu do an active scan of just the insertion point defined by that selection.
* [Host Header Inchecktion](https://github.com/fabianbinna/host_header_inchecktion) ⭐ 8 | 🐛 0 | 🌐 Java | 📅 2026-04-13 - This burp extension helps to find host header injection vulnerabilities by actively testing a set of injection types. A scan issue is created if an injection was successful.
* [Server-Side Prototype Pollution Scanner](https://github.com/hackvertor/server-side-prototype-pollution) ⭐ 7 | 🐛 0 | 🌐 Java | 📅 2023-03-13 - This extension identifies server side prototype pollution vulnerabilities, and requires Burp Suite v2021.9 or later.
* [Cypher Injection Scanner](https://github.com/morkin1792/cypher-injection-scanner) ⭐ 6 | 🐛 0 | 🌐 Java | 📅 2020-09-18 - A Burp Suite Extension that detects Cypher code injection
* [HTML5 Auditor](https://github.com/PortSwigger/html5-auditor) ⭐ 5 | 🐛 1 | 🌐 Java | 📅 2023-12-01 - This extension checks for usage of HTML5 features that have potential security risks.
* [Noopener Burp Extension](https://github.com/snoopysecurity/Noopener-Burp-Extension) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2018-06-08 - Find Target=\_blank values within web pages that are set without noopener and noreferrer attributes.
* [Discover Reverse Tabnabbing](https://github.com/GabsJahBless/discovering-reversetabnabbing) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2019-12-06 - Identify areas in your application that are vulnerable to Reverse Tabnabbing.
* [iRule Detector](https://github.com/kugg/irule-detector) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2019-08-08 - Detect a Remote Code or Command Execution (RCE) vulnerability in some implementations of F5 Networks’ popular BigIP load balancer.
* [JSON array issues for Burp Suite](https://github.com/silentsignal/burp-json-array) ⭐ 4 | 🐛 0 | 🌐 Java | 📅 2016-12-08 - JSON Array issues plugin for Burp Suite.
* [PasskeyScanner](https://github.com/alexcowperthwaite/PasskeyScanner) ⭐ 3 | 🐛 0 | 🌐 Java | 📅 2023-10-30 - This is a BurpSuite plugin that recognizes and scans Passkey (webauthn) protocols and detects security issues.
...
* [HaE - Highlighter and Extractor](https://github.com/gh0stkey/HaE) ⭐ 4,359 | 🐛 0 | 📅 2026-07-31 - HaE is used to highlight HTTP requests and extract information from HTTP response messages.
* [Burp Bounty - Scan Check Builder](https://github.com/wagiro/BurpBounty) ⭐ 1,810 | 🐛 7 | 🌐 Java | 📅 2024-04-26 - This BurpSuite extension allows you, in a quick and simple way, to improve the active and passive burpsuite scanner by means of personalized rules through a very intuitive graphical interface.
* [GAP-Burp-Extension](https://github.com/xnl-h4ck3r/GAP-Burp-Extension) ⭐ 1,528 | 🐛 5 | 🌐 Python | 📅 2026-01-08 - This is an evolution of the original getAllParams extension for Burp. Not only does it find more potential parameters for you to investigate, but it also finds potential links to try these parameters on, and produces a target specific wordlist to use for fuzzing.
* [PwnFox](https://github.com/B-i-t-K/PwnFox) ⭐ 1,334 | 🐛 20 | 🌐 JavaScript | 📅 2024-08-07 - PwnFox is a Firefox/Burp extension that provide usefull tools for your security audit.
* [IP Rotate](https://github.com/RhinoSecurityLabs/IPRotate_Burp_Extension) ⭐ 893 | 🐛 2 | 🌐 Python | 📅 2026-02-23 - Extension for Burp Suite which uses AWS API Gateway to rotate your IP on every request.
...
* [match-replace-burp](https://github.com/daffainfo/match-replace-burp) ⭐ 375 | 🐛 0 | 📅 2023-09-26 - Useful Match and Replace BurpSuite Rules
...
* [cstc](https://github.com/usdAG/cstc) ⭐ 265 | 🐛 8 | 🌐 Java | 📅 2026-08-10 - CSTC is a Burp Suite extension that allows request/response modification using a GUI analogous to CyberChef.
...
* [Burp-Send-To-Extension](https://github.com/bytebutcher/burp-send-to) ⭐ 169 | 🐛 4 | 🌐 Java | 📅 2022-11-27 - Adds a customizable "Send to..."-context-menu to your BurpSuite.
...
* [SocketSleuth](https://github.com/snyk/socketsleuth) ⭐ 107 | 🐛 5 | 🌐 Java | 📅 2026-08-10 - SocketSleuth aims to enhance Burp Suite's websocket testing capabilities and make testing websocket based applications easier.
* [SocketSleuth](https://github.com/snyk/socketsleuth) ⭐ 107 | 🐛 5 | 🌐 Java | 📅 2026-08-10 - Burp Extension to add additional functionality for pentesting websocket based applications
...
* [Burp-IndicatorsOfVulnerability](https://github.com/codewatchorg/Burp-IndicatorsOfVulnerability) ⭐ 42 | 🐛 0 | 🌐 Java | 📅 2022-12-23 - Burp extension that checks application requests and responses for indicators of vulnerability or targets for attack
* [Copy Regex Matches](https://github.com/honoki/burp-copy-regex-matches) ⭐ 35 | 🐛 0 | 🌐 Java | 📅 2022-02-12 - Copy Regex Matches is a Burp Suite plugin to copy regex matches from selected requests and/or responses to the clipboard.
...
* [WebSocket Turbo Intruder](https://github.com/Hannah-PortSwigger/WebSocketTurboIntruder) ⭐ 20 | 🐛 4 | 🌐 Java | 📅 2024-08-21 - Extension to fuzz WebSocket messages using custom  code
* [Response Pattern Matcher](https://github.com/JackJ07/Response-Pattern-Matcher) ⭐ 16 | 🐛 0 | 🌐 Java | 📅 2023-08-04 - Adds extensibility to Burp by using a list of payloads to pattern match on HTTP responses highlighting interesting and potentially vulnerable areas.
* [reDOM](https://github.com/weirdmachine64/reDOM) ⭐ 15 | 🐛 0 | 🌐 Java | 📅 2026-05-11 - reDOM is Burp Suite extension that brings full DOM rendering capabilities directly into Burp, enabling effective security testing of modern JavaScript-heavy applications built with frameworks like ReactJS, VueJS, Angular, and more.
* [Auto-Drop Requests](https://github.com/sunny0day/burp-auto-drop) ⭐ 10 | 🐛 1 | 🌐 Java | 📅 2023-03-10 - Burp extension to automatically drop requests that match a certain regex.
* [Auto Drop](https://github.com/sunny0day/burp-auto-drop) ⭐ 10 | 🐛 1 | 🌐 Java | 📅 2023-03-10 - This extension allows you to automatically Drop requests that match a certain regex. Helpful in case the target has logging or tracking services enabled.
* [Custom Send To](https://github.com/PortSwigger/custom-send-to) ⭐ 8 | 🐛 0 | 🌐 Java | 📅 2022-02-10 - Adds a customizable "Send to..."-context-menu to your BurpSuite.
* [Request Highlighter](https://github.com/BeDefended/RequestHighlighter) ⭐ 5 | 🐛 1 | 🌐 Java | 📅 2018-07-23 - Request Highlighter is a simple extension for Burp Suite tool (for both community and professional editions) that provides an automatic way to highlight HTTP requests based on headers content (eg. Host, User-Agent, Cookies, Auth token, custom headers etc.).
* [Add & Track Custom Issues](https://github.com/JAMESM0RR1S/Add-And-Track-Custom-Issues) ⭐ 4 | 🐛 3 | 🌐 Python | 📅 2019-04-19 - This extension allows custom scan issues to be added and tracked within Burp.
* [Add & Track Custom Issues](https://github.com/jamesm0rr1s/BurpSuite-Add-and-Track-Custom-Issues) ⭐ 4 | 🐛 3 | 🌐 Python | 📅 2019-04-19 - This extension allows custom scan issues to be added and tracked within Burp.
* [RepeaterClips](https://github.com/0xd0ug/burpExtensions-clipboardRepeater) ⭐ 4 | 🐛 0 | 🌐 Java | 📅 2021-01-16 - The RepeaterClips extension lets you share requests with just two clicks and a paste.
* [BatchRepeater](https://github.com/Mathemag1cian/BatchRepeater) ⭐ 4 | 🐛 0 | 🌐 Java | 📅 2024-08-26 - BatchRepeater is a BurpSuite extension that enhances the functionality of the Repeater tool by allowing users to send multiple selected HTTP requests to the Repeater in a single action.
* [pip3line](https://github.com/portswigger/pip3line) ⭐ 3 | 🐛 0 | 🌐 C++ | 📅 2019-07-12 - Raw bytes manipulation utility, able to apply well known and less well known transformations.
* [Response Grepper](https://github.com/b4dpxl/Burp-ResponseGrepper) ⭐ 3 | 🐛 2 | 🌐 Python | 📅 2021-03-04 - This Burp extension will auto-extract and display values from HTTP Response bodies based on a Regular Expression.
* [HAR Importer](https://github.com/fortalice/HARImporter) ⭐ 3 | 🐛 1 | 🌐 Java | 📅 2023-07-17 - A HAR importer.
* [CookieMonster](https://github.com/baegmon/CookieMonster) ⭐ 3 | 🐛 0 | 🌐 Java | 📅 2024-03-25 -  A Burp Suite plugin to easily manage cookies
* [Decoder Pro](https://github.com/Matanatr96/DecoderProBurpSuite) ⭐ 2 | 🐛 0 | 🌐 Java | 📅 2018-07-24 - Burp Suite Plugin to decode and clean up garbage response text.
* [Conditional Match and Replace (CMAR)](https://github.com/CyberCX-STA/cmar) ⭐ 2 | 🐛 3 | 🌐 Java | 📅 2025-10-22 - An extension allowing you to create match and replace operations that execute only when a condition is matched (or not matched). The condition can be matched against the request Header/Body/All, or the response Header/Body/All. If the condition is matched, you can apply a match and replace rule against the specified area. You can create a condition that matches a request, then performs a match and replace in the response.
* [WebAuthn CBOR Decoder](https://github.com/srikanthramu/webauthn-cbor-burp) ⭐ 1 | 🐛 5 | 🌐 Java | 📅 2022-07-05 - WebAuthn CBOR is a Burp Extension to decode WebAuthn CBOR format. WebAuthn is a W3C Standard to support strong authentication of users.
* [Diff Last Response](https://github.com/hackvertor/diffy) ⭐ 0 | 🐛 1 | 🌐 Java | 📅 2022-07-25 - Diff last response will show the difference between the previous and current response.
...
* [Cyber Security Transformation Chef](https://github.com/usdAG/cstc) ⭐ 265 | 🐛 8 | 🌐 Java | 📅 2026-08-10 - The Cyber Security Transformation Chef (CSTC) is a Burp Suite extension. It is build for security experts to extend Burp Suite for chaining simple operations for each incomming or outgoing message.
...
* [JSON Beautifier](https://github.com/NetSPI/JSONBeautifier) ⭐ 42 | 🐛 8 | 🌐 Java | 📅 2019-11-20 - JSON Beautifier for Burp written in Java
* [JSON JTree viewer for Burp Suite](https://github.com/silentsignal/burp-json-jtree) ⭐ 39 | 🐛 1 | 🌐 Java | 📅 2021-10-04 - JSON JTree viewer for Burp Suite.
* [JSONPath](https://github.com/augustd/burp-suite-jsonpath) ⭐ 30 | 🐛 3 | 🌐 Java | 📅 2025-11-02 - Burp Suite extension to view and extract data from JSON responses.
* [burp-suite-jsonpath](https://github.com/augustd/burp-suite-jsonpath) ⭐ 30 | 🐛 3 | 🌐 Java | 📅 2025-11-02 - Burp Suite extension to view and extract data from JSON responses.
* [GraphQL Beautifier](https://github.com/zidekmat/graphql_beautifier) ⭐ 29 | 🐛 2 | 🌐 Ruby | 📅 2017-12-07 - Burp Suite extension to help make Graphql request more readable.
* [GraphQL Raider](https://github.com/denniskniep/GQLRaider) ⭐ 21 | 🐛 12 | 🌐 Java | 📅 2022-09-16 - GraphQL Raider is a Burp Suite Extension for testing endpoints implementing GraphQL.
* [ViewState Editor](https://github.com/portswigger/viewstate-editor) ⭐ 18 | 🐛 0 | 🌐 Java | 📅 2021-02-23 - This extension allows Burp users to view & edit the contents of ViewState.
* [JSON/JS Beautifier](https://github.com/Manjesh24/JSON-JS-Beautifier) ⭐ 15 | 🐛 2 | 🌐 Python | 📅 2019-09-17 - This is a Burp Extension for beautifying JSON and JavaScript output to make the body parameters more human readable.
* [Deflate Burp Plugin](https://github.com/GDSSecurity/Deflate-Burp-Plugin) ⭐ 13 | 🐛 0 | 🌐 Java | 📅 2011-07-19 - The Deflate Burp Plugin is a plug-in for Burp Proxy (it implements the IBurpExtender interface) that decompresses HTTP response content in the ZLIB (RFC1950) and DEFLATE (RFC1951) compression formats.
* [.NET Beautifier](https://github.com/allfro/dotNetBeautifier) ⭐ 12 | 🐛 1 | 🌐 Java | 📅 2015-06-29 - A BurpSuite extension for beautifying .NET message parameters and hiding some of the extra clutter that comes with .NET web apps (i.e. \_\_VIEWSTATE).
* [Browser Repeater](https://github.com/allfro/browserRepeater) ⭐ 7 | 🐛 1 | 🌐 Perl | 📅 2014-04-01 - BurpSuite extension for Repeater tool that renders responses in a real browser.
* [Burp Suite GWT wrapper](https://github.com/dnet/burp-gwt-wrapper) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2013-05-02 - Burp Suite GWT wrapper
* [Burp-Timestamp-Editor](https://github.com/b4dpxl/Burp-Timestamp-Editor) ⭐ 3 | 🐛 0 | 🌐 Java | 📅 2021-05-27 - Provides a GUI to view and edit Unix timestamps in Burp message editors.
* [Burp ASN1 Toolbox](https://github.com/silentsignal/burp-asn1) ⭐ 2 | 🐛 0 | 🌐 Java | 📅 2017-12-06 - ASN.1 toolbox for Burp Suite.
* [Burp Beautifier](https://github.com/Ovi3/BurpBeautifier) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2021-04-15 - BurpBeautifier is a Burpsuite extension for beautifying request/response body, supporting JS, JSON, HTML, XML format, writing in Jython 2.7.
...
* [Burpkit](https://github.com/allfro/BurpKit) ⭐ 459 | 🐛 6 | 🌐 JavaScript | 📅 2016-01-27 - BurpKit is a BurpSuite plugin which helps in assessing complex web apps that render the contents of their pages dynamically.
* [Burp Buddy](https://github.com/tomsteele/burpbuddy) ⭐ 158 | 🐛 2 | 🌐 Java | 📅 2018-11-29 - burpbuddy exposes Burp Suites's extender API over the network through various mediums, with the goal of enabling development in any language without the restrictions of the JVM.
* [Burp Requests](https://github.com/silentsignal/burp-requests) ⭐ 146 | 🐛 0 | 🌐 Java | 📅 2024-08-22 - Copy as requests plugin for Burp Suite.
* [Burpy](https://github.com/debasishm89/burpy) ⭐ 124 | 🐛 1 | 🌐 Python | 📅 2018-04-04 - Portable and flexible web application security assessment tool.It parses Burp Suite log and performs various tests depending on the module provided and finally generate a HTML report.
* [Copy As Python-Requests](https://github.com/portswigger/copy-as-python-requests) ⭐ 66 | 🐛 1 | 🌐 Java | 📅 2024-09-24 - This extension copies selected request(s) as Python-Requests invocations.
...
* [JScriptor](https://github.com/ngduyquockhanh/JScriptor) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-05-07 - Pre-Script and Post-Script like Postman extension for Burpsuite
...
* [Copy as JavaScript Request](https://github.com/celsogbezerra/Copy-as-JavaScript-Request) ⭐ 5 | 🐛 1 | 🌐 Java | 📅 2019-05-31 - This Burp Extension copies the selected request to the clipboard as JavaScript Fetch API.
* [Burp Jython Tab](https://github.com/mwielgoszewski/burp-jython-tab) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2016-02-11 - Description not available.
* [Kollaborator Module Builder](https://github.com/mbkunal/KollaboratorModuleBuilder) ⭐ 0 | 🐛 0 | 🌐 Java | 📅 2023-11-14 - Burp suite extension to build and handle collaborator interaction.
...
* [SAML Raider](https://github.com/SAMLRaider/SAMLRaider) ⭐ 447 | 🐛 15 | 🌐 Java | 📅 2026-02-24 - SAML Raider is a Burp Suite extension for testing SAML infrastructures. It contains two core functionalities: Manipulating SAML Messages and manage X.509 certificates.
* [OAUTHScan](https://github.com/akabe1/OAUTHScan) ⭐ 178 | 🐛 1 | 🌐 Java | 📅 2024-10-26 - OAUTHScan is a Burp Suite Extension written in Java with the aim to provide some automatic security checks, which could be useful during penetration testing on applications implementing OAUTHv2 and OpenID standards.
...
* [JWT Editor](https://github.com/DolphFlynn/jwt-editor) ⭐ 31 | 🐛 10 | 🌐 Java | 📅 2026-08-10 - A Burp Suite extension for creating and editing JSON Web Tokens.
...
* [Burp CSJ](https://github.com/malerisch/burp-csj) ⭐ 34 | 🐛 6 | 🌐 Java | 📅 2014-12-22 - This extension integrates Crawljax, Selenium and JUnit together. The intent of this extension is to aid web application security testing, increase web application crawling capability and speed-up complex test-cases execution.
* [BigIP Discover](https://github.com/raise-isayan/BigIPDiscover) ⭐ 16 | 🐛 0 | 🌐 Java | 📅 2026-03-10 - A extension of Burp suite. The cookie set by the BipIP server may include a private IP, which is an extension to detect that IP
* [Filter OPTIONS Method](https://github.com/capt-meelo/filter-options-method) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2022-10-01 - A Burp extension that filters out OPTIONS requests from populating Burp's Proxy history.
* [Directory File Listing Parser Importer](https://github.com/SmeegeSec/Directory_File_Listing_Parser_Importer) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2013-07-15 - This is a Burp Suite extension in Python to parse a directory and file listing text file of a web application.
* [SAN Scanner](https://github.com/seisvelas/SAN-Scanner) ⭐ 3 | 🐛 3 | 🌐 Java | 📅 2020-10-01 - SAN Scanner is a Burp Suite extension for enumerating associated domains & services via the Subject Alt Names section of SSL certificates.
* [Add to sitemap++](https://github.com/quahac/burp-add-to-sitemap-plusplus) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2022-10-27 - Add to sitemap++ is a BURP extension that can read URLs from files or clipboard and add the discovered information on the site map of the selected host(s).
* [Look Over There](https://github.com/yg-ht/Burp-LookOverThere) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2023-04-26 - This is a Burp Suite extension to help Burp know where to look during scanning.
...
* [Reflector](https://github.com/elkokc/reflector) ⭐ 1,212 | 🐛 14 | 🌐 Java | 📅 2021-02-02 - Burp plugin able to find reflected XSS on page in real-time while browsing on site
...
* [Autorize](https://github.com/Quitten/Autorize) ⭐ 1,168 | 🐛 9 | 🌐 Python | 📅 2026-03-21 - Automatic authorization enforcement detection extension for burp suite written in Jython developed by Barak Tawily in order to ease application security people work and allow them perform an automatic authorization tests.
...
* [Auth Analyzer](https://github.com/simioni87/auth_analyzer) ⭐ 221 | 🐛 14 | 🌐 Java | 📅 2025-11-04 - This Burp Extension helps you to find authorization bugs by repeating Proxy requests with self defined headers and tokens.
* [Paramalyzer](https://github.com/JGillam/burp-paramalyzer) ⭐ 159 | 🐛 11 | 🌐 Java | 📅 2025-07-10 - Paramalyzer - Burp extension for parameter analysis of large-scale web application penetration tests.
* [AdminPanelFinder](https://github.com/moeinfatehi/Admin-Panel_Finder) ⭐ 123 | 🐛 1 | 🌐 Java | 📅 2022-06-16 - A burp suite extension that enumerates infrastructure and application Admin Interfaces (OWASP OTG-CONFIG-005)
...
* [Additional CSRF Checks/EasyCSRF](https://github.com/0ang3el/EasyCSRF) ⭐ 162 | 🐛 3 | 🌐 Python | 📅 2017-12-07 - EasyCSRF helps to find weak CSRF-protection in WebApp which can be easily bypassed.
* [burp-multistep-csrf-poc](https://github.com/wrvenkat/burp-multistep-csrf-poc) ⭐ 31 | 🐛 0 | 🌐 Java | 📅 2019-09-23 - Burp extension to generate multi-step CSRF POC.
* [CSRF Scanner](https://github.com/ah8r/csrf) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2018-06-05 -  CSRF Scanner Extension for Burp Suite Pro.
* [CSurfer](https://github.com/asaafan/CSurfer) ⭐ 18 | 🐛 3 | 🌐 Java | 📅 2015-10-07 - CSurfer is a CSRF guard hiding extension that keeps track of the latest guard value per session and update new requests accordingly.
* [Token Rewrite](https://github.com/hvqzao/burp-token-rewrite) ⭐ 16 | 🐛 0 | 🌐 Java | 📅 2018-02-27 - This extension lets you search for specific values like CSRF tokens in responses and use their values to modify parameters in future requests or set a cookie.
* [burp-samesite-reporter](https://github.com/ldionmarcil/burp-samesite-reporter) ⭐ 6 | 🐛 2 | 🌐 Java | 📅 2020-06-01 - Burp extension that passively reports various SameSite flags.
* [Anti-CSRF Token From Referer](https://github.com/CompassSecurity/anti-csrf-token-from-referer) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2020-07-23 - The extension works by registering a new session handling rule called "Anti-CSRF token from referer".
...
* [BurpJDSer](https://github.com/NetSPI/Burp-Extensions/tree/master/BurpJDSer) ⭐ 150 | 🐛 6 | 🌐 Java | 📅 2021-11-18 - BurpJDSer is a Burp plugin that will deserialze/serialize Java request and response to and from XML with the use of Xtream library.
* [PHP Object Injection Slinger](https://github.com/ricardojba/poi-slinger) ⭐ 43 | 🐛 2 | 🌐 Java | 📅 2025-07-07 - Designed to help you find PHP Object Injection vulnerabilities on popular PHP Frameworks.
* [BurpJDSer-ng](https://github.com/IOActive/BurpJDSer-ng) ⭐ 15 | 🐛 3 | 🌐 Java | 📅 2014-06-12 - Allows you to deserialize java objects to XML and lets you dynamically load classes/jars as needed.
...
* [GAP-Burp-Extension](https://github.com/xnl-h4ck3r/GAP-Burp-Extension) ⭐ 1,528 | 🐛 5 | 🌐 Python | 📅 2026-01-08 - This is an evolution of the original getAllParams extension for Burp. Not only does it find more potential parameters for you to investigate, but it also finds potential links to try these parameters on.
...
* [Xkeys](https://github.com/vsec7/BurpSuite-Xkeys) ⭐ 313 | 🐛 2 | 🌐 Python | 📅 2024-07-09 - A Burp Suite Extension to extract interesting strings (key, secret, token, or etc.) from a webpage. and lists them as information issues.
...
* [Levo Burp Extension](https://github.com/levoai/levoai-burp-extension) ⭐ 31 | 🐛 5 | 🌐 Java | 📅 2026-08-10 - Build OpenApi specs from Burp's traffic using Levo.ai. Also detect and classify the PII, and annotate specs with the PII details.
...
* [Headers Burp Extension](https://github.com/dh0ck/Headers) ⭐ 20 | 🐛 0 | 🌐 Python | 📅 2023-06-07 - It removes the hassle of reporting missing security headers in your pentest reports.
...
* [SQLiPy](https://github.com/codewatchorg/sqlipy) ⭐ 260 | 🐛 6 | 🌐 Python | 📅 2025-05-16 - SQLiPy is a Python plugin for Burp Suite that integrates SQLMap using the SQLMap API.
...
* [burp-xss-sql-plugin](https://github.com/attackercan/burp-xss-sql-plugin) ⭐ 44 | 🐛 0 | 🌐 Python | 📅 2016-09-28 - ublishing plugin which I used for years which helped me to find several bugbounty-worthy XSSes, OpenRedirects and SQLi.
* [Burp NoSQLi Scanner](https://github.com/matrix/Burp-NoSQLiScanner) ⭐ 31 | 🐛 0 | 🌐 Java | 📅 2025-09-07 - NoSQL Injection scans for Burp
* [SQLMap DNS Collaborator](https://github.com/lucacapacci/SqlmapDnsCollaborator) ⭐ 12 | 🐛 0 | 🌐 Java | 📅 2021-10-07 - SqlmapDnsCollaborator is a Burp Extension that lets you perform DNS exfiltration with Sqlmap with zero configuration needed.
* [Burptime](https://github.com/virusdefender/burptime) ⭐ 11 | 🐛 0 | 🌐 Java | 📅 2019-06-21 - Show time cost in burp proxy history, it's useful when testing time-based sql injection..
...
* [Office OpenXML Editor](https://github.com/PortSwigger/office-open-xml-editor) ⭐ 13 | 🐛 0 | 🌐 Python | 📅 2018-01-05 - Burp extension that add a tab to edit Office Open XML document (xlsx,docx,pptx).

### Insecure File Uploads

* [Upload Scanner](https://github.com/modzero/mod0BurpUploadScanner) ⚠️ Archived - A Burp Suite Pro extension to do security tests for HTTP file uploads.
* [ZIP File Raider](https://github.com/destine21/ZIPFileRaider) ⭐ 71 | 🐛 2 | 🌐 Python | 📅 2020-08-31 - Burp Extension for ZIP File Payload Testing.
...
* [Uploader](https://github.com/thec00n/Uploader) ⭐ 5 | 🐛 2 | 🌐 Ruby | 📅 2017-08-02 - Burp extension to test for directory traversal attacks in insecure file uploads.

### Session Management

* [Authentication Token Obtain and Replace (ATOR)](https://github.com/synopsys-sig/ATOR-Burp) ⭐ 91 | 🐛 17 | 🌐 Java | 📅 2024-04-24 - The plugin is created to help automated scanning using Burp in certain session management scenarios.
* [BearerAuthToken](https://github.com/twelvesec/BearerAuthToken) ⭐ 49 | 🐛 0 | 📅 2019-02-27 - This burpsuite extender provides a solution on testing Enterprise applications that involve security Authorization tokens into every HTTP requests.
* [Cookie Decrypter](https://github.com/SolomonSklash/cookie-decrypter) ⭐ 12 | 🐛 0 | 🌐 Python | 📅 2019-06-12 - A Burp Suite Professional extension for decrypting/decoding various types of cookies.
* [AuthHeader Updater](https://github.com/sampsonc/AuthHeaderUpdater) ⭐ 9 | 🐛 0 | 🌐 Java | 📅 2018-09-18 - Burp extension to specify the token value for the Authenication header while scanning.
* [Add Request to Macro](https://github.com/pajswigger/add-request-to-macro) ⭐ 7 | 🐛 0 | 🌐 Java | 📅 2018-07-12 - This Burp extension lets you add a request to an existing macro.
* [Session-Handler-Plus](https://github.com/V9Y1nf0S3C/Session-Handler-Plus) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2023-04-22 - The Session Handler Plus (SH+) Burp Suite extension offers enhanced session handling capabilities for JWTs, access tokens, refresh tokens, and CSRF tokens. Additionally, it allows for custom scripts to be launched through session handling actions, and facilitates the triggering of Selenium automation to execute complex or JavaScript based login procedures.
* [Burp Wicket Handler](https://github.com/Meatballs1/burp_wicket_handler/tree/8047692597e837de02810b5ef3ad97ed0da1385a) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2013-07-12 - Used as part of Burps Session Handling, Record a Macro which just gets the page you want to submit
...
* [CORS\* - Additional CORS Checks](https://github.com/ybieri/Additional_CORS_Checks) ⭐ 10 | 🐛 2 | 🌐 Kotlin | 📅 2022-05-20 - This extension can be used to test websites for CORS misconfigurations.
...
* [tplmap Burp Extenson](https://github.com/epinna/tplmap/tree/master/burp_extension) ⭐ 4,193 | 🐛 46 | 🌐 Python | 📅 2024-04-21 - Burp extension for Tplmap, a Server-Side Template Injection and Code Injection Detection and Exploitation Tool

### Type Confusion

* [Type Confusion Extension](https://github.com/certuscyber/bapp-certus) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2023-05-16 - This Burp Extension was created by Certus Cybersecurity to help find type confusion vulnerablities in applications.

### SSRF

* [Encode IP](https://github.com/e1abrador/Burp-Encode-IP) ⭐ 48 | 🐛 0 | 🌐 Python | 📅 2024-03-04 - This extension will encode an IP address using a variety of lesser-known encoding techniques

## Web Application Firewall Evasion

*The following extensions can aid during WAF evasion.*

* [Chunked coding converter](https://github.com/c0ny1/chunked-coding-converter) ⭐ 2,030 | 🐛 5 | 🌐 Java | 📅 2022-02-23 - This entension use a Transfer-Encoding technology to bypass the waf.
* [Awesome TLS](https://github.com/sleeyax/burp-awesome-tls) ⭐ 1,887 | 🐛 10 | 🌐 Java | 📅 2026-08-06 - This extension overrides Burp Suite's default HTTP and TLS stack to make it immune to WAF fingerprinting methods such as JA3, HTTP2 frames, etc.
...
* [WAF Bypadd](https://github.com/julianjm/waf_bypadd) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2023-07-23 - This Burp Suite extension is designed to bypass Web Application Firewalls (WAFs) by padding HTTP requests with dummy data.
...
* [Logger++](https://github.com/nccgroup/BurpSuiteLoggerPlusPlus) ⭐ 712 | 🐛 35 | 🌐 Java | 📅 2024-05-31 - Burp Suite Logger++: Log activities of all the tools in Burp Suite.
...
* [Progress Tracker](https://github.com/dariusztytko/progress-burp) ⭐ 59 | 🐛 5 | 🌐 Python | 📅 2020-03-07 - Burp Suite extension to track vulnerability assessment progress.
* [Burp Suite Importer](https://github.com/SmeegeSec/Burp-Importer) ⭐ 48 | 🐛 2 | 🌐 Python | 📅 2020-05-15 - Connect to multiple web servers while populating the sitemap.
* [Sink Logger](https://github.com/bayotop/sink-logger) ⚠️ Archived - Sink Logger is a Burp Suite Extension that allows to transparently monitor various JavaScript sinks.
* [Burp Savetofile](https://github.com/jksecurity/burp_savetofile) ⭐ 21 | 🐛 0 | 🌐 Java | 📅 2016-10-02 - BurpSuite plugin to save just the body of a request or response to a file
* [Scope Monitor](https://github.com/portswigger/scope-monitor) ⭐ 16 | 🐛 1 | 📅 2021-03-31 - A Burp Suite Extension to monitor and keep track of tested endpoints.
* [Burp Response Clusterer](https://github.com/modzero/burp-ResponseClusterer) ⭐ 14 | 🐛 2 | 🌐 Python | 📅 2019-06-07 - Burp plugin that clusters responses to show an overview of received responses.
* [Log Viewer](https://github.com/ax/burp-logs) ⭐ 10 | 🐛 2 | 🌐 Java | 📅 2021-11-15 - Lets you view log files generated by Burp in a graphical enviroment.
* [Rapid](https://github.com/iamaldi/rapid) ⭐ 8 | 🐛 0 | 🌐 Java | 📅 2020-04-18 - A fairly simple Burp Suite extension that enables you to save HTTP Requests and Responses to files a lot faster and in one go.
* [Burp Git Version](https://github.com/silentsignal/burp-git-version) ⭐ 6 | 🐛 1 | 🌐 Java | 📅 2023-09-29 - Description not available.
* [Burp Commentator](https://github.com/silentsignal/burp-commentator) ⭐ 6 | 🐛 1 | 🌐 Java | 📅 2018-06-28 - Generates comments for selected request(s) based on regular expressions.
* [Burp Collect500](https://github.com/floyd-fuh/burp-Collect500) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2017-01-17 - Burp plugin that collects all HTTP 500 messages.
* [Burp SQLite logger](https://github.com/silentsignal/burp-sqlite-logger) ⭐ 1 | 🐛 2 | 🌐 Java | 📅 2021-08-30 - SQLite logger for Burp Suite.
...
* [Turbo Intruder](https://github.com/PortSwigger/turbo-intruder) ⭐ 1,795 | 🐛 19 | 🌐 Kotlin | 📅 2026-08-06 - Turbo Intruder is a Burp Suite extension for sending large numbers of HTTP requests and analyzing the results.
* [HackBar](https://github.com/d3vilbug/HackBar) ⭐ 1,633 | 🐛 0 | 🌐 Java | 📅 2021-04-15 - HackBar plugin for Burpsuite v1.0.
* [GAP (Get All Parameters, Links, and Words)](https://github.com/xnl-h4ck3r/GAP-Burp-Extension) ⭐ 1,528 | 🐛 5 | 🌐 Python | 📅 2026-01-08 - This extension helps find potential endpoints, parameters, and generate a custom target wordlist.
...
* [reCAPTCHA](https://github.com/bit4woo/reCAPTCHA.git) ⭐ 808 | 🐛 5 | 🌐 Java | 📅 2023-11-23 - A burp plugin that automatically recognizes the graphics verification code and is used for Payload in Intruder.
* [Agartha - LFI, RCE, SQLi, Authentication, Authorization and Copy as JavaScript](https://github.com/volkandindar/agartha) ⭐ 401 | 🐛 0 | 🌐 Python | 📅 2026-05-28 - Agartha is a penetration testing tool which creates dynamic payload lists and user access matrix to reveal injection flaws and authentication/authorization issues.
* [Gather Contacts](https://github.com/clr2of8/GatherContacts) ⭐ 208 | 🐛 0 | 🌐 Java | 📅 2024-07-06 - A Burp Suite Extension to pull Employee Names from Google and Bing LinkedIn Search Results.
...
* [Hashcat Maskprocessor Intruder Payloads](https://github.com/quahac/burp-intruder-hashcat-maskprocessor) ⭐ 20 | 🐛 0 | 🌐 Python | 📅 2020-10-05 - Burp Hashcat Maskprocessor Extension, inspired by hashcat maskprocessor <https://github.com/hashcat/maskprocessor> ⭐ 505 | 🐛 14 | 🌐 C | 📅 2022-06-20
...
* [Username Generator](https://github.com/jstrosch/Username_Generator) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2019-09-24 - This is a Python extension that will parse email addresses out of selected URLs from the target tab and display them in the output window of the Extensions tab.
* [Fuzzy Encoding Generator](https://github.com/GoSecure/burp-fuzzy-encoding-generator) ⭐ 7 | 🐛 0 | 🌐 Kotlin | 📅 2022-02-01 - This extension allows a user to quickly test various encoding for a given value in Burp Intruder.
* [Payload Parser](https://github.com/infodel/burp.extension-payloadparser) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2013-03-15 - Burp Extension for parsing payloads containing/excluding characters you provide.
* [Adhoc Payload Processors](https://github.com/GeoffWalton/burp--Adhoc-Payload-Processors) ⭐ 4 | 🐛 0 | 🌐 Ruby | 📅 2022-01-18 - Generate payload processors on the fly, without having to create individual extensions.
* [Sheet Intruder](https://github.com/Redguard/Sheet-Intruder) ⭐ 4 | 🐛 0 | 🌐 Java | 📅 2024-03-19 - Sheet Intruder is a Burp Suite extension designed to simplify the process of fuzzing for Excel file uploads. It works by representing the content of an Excel file as a tag, which can then be integrated into various locations. This tag then allows configuration such as replacements for fuzzing targets.
...
* [BurpCrypto](https://github.com/whwlsfb/BurpCrypto) ⭐ 1,647 | 🐛 16 | 🌐 Java | 📅 2023-08-04 - Burpcrypto is a collection of burpsuite encryption plug-ins, supporting AES/RSA/DES/ExecJs(execute JS encryption code in burpsuite).
* [AES Killer](https://github.com/Ebryx/AES-Killer) ⭐ 651 | 🐛 7 | 🌐 Java | 📅 2022-08-03 - Burp plugin to decrypt AES Encrypted traffic of mobile apps on the fly.
* [WhatsApp Protocol Decryption Burp Tool](https://github.com/romanzaikin/BurpExtension-WhatsApp-Decryption-CheckPoint) ⭐ 645 | 🐛 10 | 🌐 Python | 📅 2019-10-21 - This tool was created during our research on Whatsapp Protocol.
* [PyCript](https://github.com/Anof-cyber/PyCript) ⭐ 220 | 🐛 0 | 🌐 Java | 📅 2026-01-09 - Burp Suite extension that allows for bypassing client-side encryption using custom logic for manual and automation testing with Python and NodeJS. It enables efficient testing of encryption methods and identification of vulnerabilities in the encryption process.
...
* [AES Burp/AES Payloads](https://github.com/lgrangeia/aesburp) ⭐ 24 | 🐛 5 | 🌐 Java | 📅 2017-08-02 - Burp Extension to manipulate AES encrypted payloads.
* [Padding Oracle Hunter](https://github.com/GovTech-CSG/PaddingOracleHunter) ⭐ 17 | 🐛 2 | 🌐 Python | 📅 2024-07-12 - Padding Oracle Hunter is a Burp Suite extension that helps penetration testers quickly identify and exploit the PKCS#7 and PKCS#1 v1.5 padding oracle vulnerability.
* [Add To TLS Pass Through Extension](https://github.com/WhiteOakSecurity/addToTLSPassThrough) ⭐ 3 | 🐛 0 | 🌐 Java | 📅 2024-01-17 - Burp Extension to add context menus for configuration of the Add to TLS Pass Through setting
* [Crypto Attacker](https://github.com/PortSwigger/crypto-attacker) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2017-02-13 - The extension helps detect and exploit some common crypto flaws.
...
* [Burp Non HTTP Extension](https://github.com/summitt/Burp-Non-HTTP-Extension) ⭐ 1,662 | 🐛 22 | 🌐 Java | 📅 2024-05-25 - Non-HTTP Protocol Extension (NoPE) Proxy and DNS for Burp Suite.
* [WSDLer](https://github.com/NetSPI/Wsdler) ⭐ 284 | 🐛 6 | 🌐 Java | 📅 2018-06-25 - WSDL Parser extension for Burp.
* [Swurg](https://github.com/AresS31/swurg) ⭐ 208 | 🐛 12 | 🌐 Java | 📅 2024-01-03 - Swurg is a Burp Suite extension designed for OpenAPI testing.
...
* [JSON Decoder](https://github.com/PortSwigger/json-decoder) ⭐ 10 | 🐛 1 | 🌐 Python | 📅 2020-02-18 - This extension adds a new tab to Burp's HTTP message editor, and displays JSON messages in decoded form.
* [POST2JSON](https://github.com/cyberisltd/POST2JSON/tree/3d6109a4749352849e5e7f27737e5384f78c4552) ⭐ 10 | 🐛 1 | 🌐 Java | 📅 2013-07-19 - Burp Suite Extension to convert a POST request to JSON message, moving any .NET request verification token to HTTP headers if present.
* [JSWS](https://github.com/NetSPI/JSWS) ⭐ 8 | 🐛 0 | 🌐 Java | 📅 2017-02-15 - Burp Extenstion to parse JavaScript WebService Proxies and create sample requests.
* [Burp WS-Security](https://github.com/RobinFassina-Moschini/Burp-WS-Security) ⭐ 0 | 🐛 0 | 🌐 Java | 📅 2019-12-11 - This extension calculate a valid WS security token for every request (In Proxy, Scanner, Intruder, Repeater, Sequencer, Extender), and replace variables in theses requests by the valid token.
...
* [Brida](https://github.com/federicodotta/Brida) ⭐ 1,886 | 🐛 11 | 🌐 Java | 📅 2025-10-30 - Brida is a Burp Suite Extension that, working as a bridge between Burp Suite and Frida, lets you use and manipulate applications’ own methods while tampering the traffic exchanged between the applications and their back-end services/servers.
...
* [Faction Burp Suite Extension ](https://github.com/factionsecurity/Faction-Burp) ⭐ 14 | 🐛 1 | 🌐 Java | 📅 2026-06-16 - This Burp Suite Extension allows you to integrate BurpSuite into the Faction assessment collaboration framework.
...
* [Nucleus Burp Extension](https://github.com/nucleus-security/Nucleus-Burp-Extension) ⭐ 3 | 🐛 12 | 🌐 Java | 📅 2023-04-14 - This extension allows Burp Suite scans to be pushed to the Nucleus platform.
* [WebInspect Connector](https://github.com/portswigger/webinspect-connector) ⭐ 0 | 🐛 0 | 🌐 HTML | 📅 2017-02-13 - Binary-only repository for the HP WebInspect Connector, authored by HP.
* [GAT Security Platform Integration](https://github.com/wmspydev/burp-gat-core-integration) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2024-11-14 - Burp Extension, integration GAT Digital
...
* [HUNT](https://github.com/bugcrowd/HUNT) ⭐ 2,328 | 🐛 12 | 🌐 Python | 📅 2026-06-10 - HUNT Suite is a collection of Burp Suite Pro/Free and OWASP ZAP extensions. Identifies common parameters vulnerable to certain vulnerability classes (Burp Suite Pro and OWASP ZAP). Organize testing methodologies (Burp Suite Pro and Free).
...
* [Autowasp](https://github.com/GovTech-CSG/Autowasp) ⭐ 76 | 🐛 9 | 🌐 Java | 📅 2022-09-02 - a Burp Suite extension that integrates Burp issues logging, with OWASP Web Security Testing Guide (WSTG), to provide a streamlined web security testing flow for the modern-day penetration tester
...
* [Similar Request Excluder](https://github.com/tijme/similar-request-excluder) ⚠️ Archived - A Burp Suite extension that automatically marks similar requests as 'out-of-scope'.
* [Copy to Bcheck](https://github.com/vrechson/copy-to-bcheck) ⭐ 34 | 🐛 0 | 🌐 Java | 📅 2023-07-18 - The purpose of this extension is to streamline the process of creating simple bcheck scripts, reducing the time required to generate them.
* [Change Menu Level](https://github.com/Ovi3/burp-menu-level) ⭐ 31 | 🐛 1 | 🌐 Java | 📅 2024-02-04 - A simple BurpSuite extension to change extension context menu level, using in BurpSuite v2021.7 version and newer.
* [Header Snipper](https://github.com/e1abrador/Burp-headerSnipper) ⭐ 25 | 🐛 0 | 🌐 Python | 📅 2023-11-12 - This extension will improve the user reporting experience. The extension is used to snip any header from all the requests with just 1 click!
* [Add Custom Header](https://github.com/lorenzog/burpAddCustomHeader) ⭐ 19 | 🐛 9 | 🌐 Java | 📅 2021-12-09 - A Burp Suite extension to add a custom header (e.g. JWT).
* [Sample Burp Suite extension: custom scanner checks](https://github.com/PortSwigger/example-scanner-checks) ⭐ 18 | 🐛 0 | 🌐 Java | 📅 2021-12-23 - Sample Burp Suite extension: custom scanner checks
* [CFURL Cache inspector for Burp Suite](https://github.com/silentsignal/burp-cfurl-cache) ⭐ 18 | 🐛 0 | 🌐 Java | 📅 2020-12-08 - CFURL Cache inspector for Burp Suite.
* [Tea Break](https://github.com/humblelad/TeaBreak) ⭐ 18 | 🐛 1 | 🌐 Java | 📅 2020-05-31 - Burp Suite extension to increase productivity among bug bounty hunters and security researchers while prompting to take break after set time to avoid burnout and health issues.
...
* [BCheck Helper](https://github.com/josh-psw/bcheck-helper) ⭐ 10 | 🐛 8 | 🌐 Java | 📅 2026-08-07 - BCheck Helper makes finding and importing BChecks scripts into Burp easier by loading them from either a remote GitHub or local Git repository.
...
* [Filter Options Method](https://github.com/capt-meelo/filter-options-method) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2022-10-01 -  Burp extension that filters out OPTIONS requests from populating Burp's Proxy history.
* [BugPoC](https://github.com/bugpoc-ryan/BugPoC-Burp-Extension) ⭐ 6 | 🐛 0 | 🌐 Java | 📅 2020-06-08 - Burp Suite Extension to send raw HTTP Requests to BugPoC.com.
* [Jython Burp Extensions](https://github.com/mwielgoszewski/jython-burp-extensions) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2012-11-16 - Description not available.
* [BurpelFish](https://github.com/bao7uo/BurpelFish) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2018-11-15 - Adds Google Translate to Burp's context menu.
* [burp-suite-paste-curl](https://github.com/augustd/burp-suite-paste-curl) ⭐ 4 | 🐛 1 | 🌐 Java | 📅 2025-12-04 - Burp Suite extension to allow pasting cURL commands into a new tab in Repeater. The pasted cURL command will be parsed into a raw HTTP request suitable for use with Repeater.
* [Copy as FFUF Command](https://github.com/phlmox/burp_copy_as_ffuf_command) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2024-05-17 - Burp Suite extension for FFUF command generation.
* [Burp-Quicker-Context-Extension](https://github.com/bytebutcher/burp-quicker-context) ⭐ 4 | 🐛 1 | 🌐 Java | 📅 2020-02-19 - This extension adds the "Quicker Context" dialog which is a lightweight dialog to select tabs or execute application- and context-menu-entries more easily by typing parts of the name or choosing one stored in history.
* [Copy Headers As -H Arguments](https://github.com/n0kovo/burp-copy-headers-as-args) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2023-02-19 - The "Copy Headers As -H Arguments" Burp Suite extension adds a new context menu entry that will copy the headers from the selected request to the clipboard in various formats
* [Asset Saver - Burp Suite](https://github.com/gaberust/burp_asset_saver) ⭐ 4 | 🐛 0 | 🌐 Java | 📅 2026-05-12 - Burp Suite extension for saving previously loaded assets .
* [Kerberos Upstream Proxy Extension for Burp Suite](https://github.com/agreenbhm/BurpKerberosUpstreamProxy) ⭐ 3 | 🐛 1 | 🌐 Java | 📅 2025-05-08 - An extension to allow the use of Burp Suite with an upstream proxy that requires Kerberos authentication.
* [SourceMapper](https://github.com/yg-ht/SourceMapper) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2025-09-14 - This is a Burpsuite extension for injecting offline source maps for easier JavaScript debugging.
* [Perfmon](https://github.com/sampsonc/Perfmon) ⭐ 1 | 🐛 0 | 🌐 Java | 📅 2018-05-22 - Perfmon is an extension for Burp Suite that shows information about threads, memory being used, and memory allocated.
* [BlockerLite](https://github.com/bomsi/BlockerLite) ⚠️ Archived - Simple Burp extension to drop blacklisted hosts.
* [Burp Suite History Explorer](https://github.com/marduc812/BurpSuiteHistoryExplorer) ⭐ 0 | 🐛 0 | 🌐 Java | 📅 2026-08-11 - This extension was developed to assist in filtering search results by host. During a large assessment I conducted, I wanted a clear view of which servers were operating on which software. While searching in Burp for the Server: .\*, it returned the desired information, but I still had to sift through each request.
...
* [Developing Burp Suite Extensions - Doyensec](https://github.com/doyensec/burpdeveltraining) ⭐ 358 | 🐛 0 | 🌐 Java | 📅 2020-10-14
* [Burp Extension Generator](https://github.com/rsrdesarrollo/generator-burp-extension) ⭐ 158 | 🐛 16 | 🌐 Java | 📅 2023-01-06
* [AIAIAI](https://github.com/Hipapheralkus/AIAIAI/) ⭐ 32 | 🐛 0 | 🌐 Python | 📅 2024-04-17
